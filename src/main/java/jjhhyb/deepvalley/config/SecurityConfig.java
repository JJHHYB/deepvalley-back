...
import jjhhyb.deepvalley.user.jwt.JWTFilter;
import jjhhyb.deepvalley.user.jwt.JWTUtil;
import jjhhyb.deepvalley.user.jwt.LoginFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        http
                ...
                .authorizeHttpRequests((auth) -> auth                                                  // 요청별 권한 설정
                        ...
                        .requestMatchers("/api/valley/*/detail", "/api/valley", "/api/facility").permitAll()
