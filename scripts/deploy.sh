...
CLOUD_AWS_REGION_STATIC=$(yq e '.CLOUD_AWS_REGION_STATIC' ./secrets.yml)
CLOUD_AWS_CREDENTIALS_ACCESS_KEY=$(yq e '.CLOUD_AWS_CREDENTIALS_ACCESS_KEY' ./secrets.yml)
CLOUD_AWS_CREDENTIALS_SECRET_KEY=$(yq e '.CLOUD_AWS_CREDENTIALS_SECRET_KEY' ./secrets.yml)
CLOUD_AWS_S3_BUCKET=$(yq e '.CLOUD_AWS_S3_BUCKET' ./secrets.yml)
